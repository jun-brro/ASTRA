...
data_path = f"./datasets/adv_img_ood/llava_{args.attack_algorithm}"
...
data.to_csv('./results/responses/llava/jb/jb_ood_llava_{}_{}_{}_alpha_{}.csv'.format(
...
total_num /= 100
for i in range(num_steer_op):
    print(steer_types[i], alphas[i], " | ASR: {:.2f}%".format(jb_num_array[i]/total_num))
