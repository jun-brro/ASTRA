...
# load datasets
data_img_path = "./results/adv_img_attr/qwen_toxic"
attack_types = ['constrain_16', 'constrain_32', 'constrain_64', 'unconstrain'] # 

for attack_type in attack_types:

    data_query = pd.read_csv('./results/queries/qwen_toxic_{}.csv'.format(attack_type))['Query'].tolist()
    ...
    save_path = "./activations/qwen/toxic"
