...
data_img_path = "./results/adv_img_attr/minigpt_toxic"
attack_types = ['constrain_16', 'constrain_32', 'constrain_64', 'unconstrain']
for attack_type in attack_types:
    data_query = pd.read_csv('./results/queries/minigpt_toxic_{}.csv'.format(attack_type))['Query'].tolist()
    ...
    save_path = "./activations/minigpt/toxic"
    torch.save(diff_attr_by_wrapper, os.path.join(save_path, f"all_diff_attr_activations_{variable_element}_{attack_type}.pt"))
