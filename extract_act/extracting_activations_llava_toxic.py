...
data_img_path = "./results/adv_img_attr/llava_toxic"
attack_types = ['constrain_16', 'constrain_32', 'constrain_64', 'unconstrain'] # 

for attack_type in attack_types:

    data_query = pd.read_csv('./results/queries/llava_toxic_{}.csv'.format(attack_type))['Query'].tolist()
    ...
    save_path = "./activations/llava/toxic"
